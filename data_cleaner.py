# To run: python3 data_cleaner.py
...
def main():
	fileNames = []
	path = input("What is the path to the .txt files from the folder that this Python program is in? (You can also type out the whole path if you want.) ")
#	path = "WIP/"
# 	the above was here so I didn't have to keep typing things over and over again
...
def cleaner(fileNames):
	for fileName in fileNames:
		...
		txt_input = "WIP/" + fileName
		csv_output = "WIP/" + fileName + ".csv"
		cleaned_csv_output = "WIP/" + "cleaned_" + fileName + ".csv"
