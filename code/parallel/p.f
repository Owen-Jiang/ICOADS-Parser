...
C      IF(NREC.GE.20)STOP 'REMOVE STOP TO READ ALL REPORTS'
      GOTO 100
C
C END OF FILE IF EOF IS NEGATIVE ELSE AN ERROR
  900 PRINT *,'Reports: ',NREC,'| End Of File: ',EOF
      END
C-----------------------------------------------------------------------3456789
...
C
      DATA FORMAT(3)
C		   YEAR     MONTH    		BSZ			  BLO			   BLA
     +/"(/,F5.0,'/',F3.0,' | Box_Size: ',F2.0,'° | Long: ',F5.1,
C			PID1 (unused)	PID2 (standard/enhanced stats)
     +'° | Lat: ',F5.1,'° | ',F1.0,' Enhanced: ',F2.0,' | Group: ',
     +F3.0,' | Checksum: ',F3.0/
     +11X,3X,'| & ','S1',6X,'Med',7X,'S5',5X,'Mean',5X,'Obs.',8X,'σ',6X,
     +'Day',3X,'Light%',7X,'+x',7X,'+y'/
     +,' S         ',F9.2,F9.2,F9.2,F9.2,F9.0,F9.2,F9.0,F9.1,F9.1,F9.1/
     +,' A         ',F9.2,F9.2,F9.2,F9.2,F9.0,F9.2,F9.0,F9.1,F9.1,F9.1/
     +,' Q         ',F9.2,F9.2,F9.2,F9.2,F9.0,F9.2,F9.0,F9.1,F9.1,F9.1/
     +,' R         ',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1)
     +"/
C
      DATA FORMAT(4)
     +/"(/,F5.0,'/',F3.0,' | Box_Size: ',F2.0,'° | Long: ',F5.1,
     ...
     +11X,3X,'| & ','S1',6X,'Med',7X,'S5',5X,'Mean',5X,'Obs.',8X,'σ',6X,
     +'Day',3X,'Light%',7X,'+x',7X,'+y'/
     +,' W         ',F9.2,F9.2,F9.2,F9.2,F9.0,F9.2,F9.0,F9.1,F9.1,F9.1/
     +,' U         ',F9.2,F9.2,F9.2,F9.2,F9.0,F9.2,F9.0,F9.1,F9.1,F9.1/
     +,' V         ',F9.2,F9.2,F9.2,F9.2,F9.0,F9.2,F9.0,F9.1,F9.1,F9.1/
     +,' P         ',F9.2,F9.2,F9.2,F9.2,F9.0,F9.2,F9.0,F9.1,F9.1,F9.1)
     +"/
C
      DATA FORMAT(5)
     +/"(/,F5.0,'/',F3.0,' | Box_Size: ',F2.0,'° | Long: ',F5.1,
     ...
     +11X,3X,'| & ','S1',6X,'Med',7X,'S5',5X,'Mean',5X,'Obs.',8X,'σ',6X,
     +'Day',3X,'Light%',7X,'+x',7X,'+y'/
     +,' C         ',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1/
     +,' R         ',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1/
     +,' X=W*U     ',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1/
     +,' Y=W*V     ',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1)
     +"/
C
      DATA FORMAT(6)
     +/"(/,F5.0,'/',F3.0,' | Box_Size: ',F2.0,'° | Long: ',F5.1,
     ...
     +11X,3X,'| & ','S1',6X,'Med',7X,'S5',5X,'Mean',5X,'Obs.',8X,'σ',6X,
     +'Day',3X,'Light%',7X,'+x',7X,'+y'/
     +,' D=S-A     ',F9.2,F9.2,F9.2,F9.2,F9.0,F9.2,F9.0,F9.1,F9.1,F9.1/
     +,' E=(S-A)*W ',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1/
     +,' F=QS-Q    ',F9.2,F9.2,F9.2,F9.2,F9.0,F9.2,F9.0,F9.1,F9.1,F9.1/
     +,' G=(QS-Q)*W',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1)
     +"/
C
      DATA FORMAT(7)
     +/"(/,F5.0,'/',F3.0,' | Box_Size: ',F2.0,'° | Long: ',F5.1,
     ...
     +11X,3X,'| & ','S1',6X,'Med',7X,'S5',5X,'Mean',5X,'Obs.',8X,'σ',6X,
     +'Day',3X,'Light%',7X,'+x',7X,'+y'/
     +,' I=U*A     ',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1/
     +,' J=V*A     ',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1/
     +,' K=U*Q     ',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1/
     +,' L=V*Q     ',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1)
     +"/
C
      DATA FORMAT(8)
     +/"(/,F5.0,'/',F3.0,' | Box_Size: ',F2.0,'° | Long: ',F5.1,
...
C
     ...
     +11X,3X,'| & ','S1',6X,'Med',7X,'S5',5X,'Mean',5X,'Obs.',8X,'σ',6X,
     +'Day',3X,'Light%',7X,'+x',7X,'+y'/
     +,' M=(QS-Q)*U',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1/
     +,' N=(QS-Q)*V',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1/
     +,' B1=W*W*W  ',F9.1,F9.1,F9.1,F9.1,F9.0,F9.1,F9.0,F9.1,F9.1,F9.1/
     +,' B2=W*W*W  ',F9.0,F9.0,F9.0,F9.0,F9.0,F9.0,F9.0,F9.1,F9.1,F9.1)
     +"/
C
